# Pet-survivors v1.15 업데이트 / 배포

## 기존 Pet-survivors Render 링크 업데이트
새 Render 서비스를 만들 필요가 없습니다.

1. `pet-survivors-phaser-v15-combat-polish.zip`을 압축 해제합니다.
...
`npm test`는 v1.15 전투 로직 테스트와 Socket.IO 방/릴레이 mock 테스트를 실행합니다.
...
6. DOWN된 동료는 기존처럼 가까이 붙어서 구조할 수 있습니다.
7. v1.15 간식은 **먹은 플레이어만** HP를 회복합니다.
