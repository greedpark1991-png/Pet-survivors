...
OUT=ROOT/'tests'/'screens-v161'
OUT.mkdir(exist_ok=True)

# deterministic visual-only park crop mirroring v1.16.1 createWorld composition
W,H=960,540
...
d.polygon(oct_pts(88,68),fill=(121,102,80)); d.polygon(oct_pts(78,58),fill=(164,141,109))
